...
- Download the design images and take a look at what you're going to be creating [here](./images/guide/full_design.png) (Full Design), [here](./images/guide/color_and_fonts.png) (Color and Fonts).
...
1. Make sure that the main HTML file of your project is called `index.html`. If it is not, you need to rename it.
2. Go to your GitHub repo on the web and click the Settings button as shown in the screenshot below.
   [Screenshot pointing to the Settings located in an example repository]
3. Click on Pages on the left side bar.
4. Change the Branch from none to the main branch and click Save.
